...
export default function Home() {
  useEffect(()=>{
    ...
    if(scroll)
    {
      var hasVerticalScrollbar = scroll.scrollHeight > scroll.clientHeight;
      if(hasVerticalScrollbar)
        scroll.classList.add("lg:pr-6")
    }
  },[]);
    ...
    <main>
      <div className='flex flex-col gap-5 w-full h-full'>
        ...
        <section className='flex flex-col gap-6 lg:flex-row lg:items-start'>
          ...
          <div className='flex gap-4 lg:flex-col live-list overflow-auto lg:overflow-x-hidden pb-6 lg:pb-0' id='scroll'>
